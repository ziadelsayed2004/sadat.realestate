...
Test overlaps, temporal boundaries, exceptions, confirmations, and prevention of retroactive mutation.
...
Create `07_finish/backend_117/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
