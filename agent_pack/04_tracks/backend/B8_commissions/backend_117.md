...
اختبر التداخل والحدود الزمنية والاستثناءات والتأكيد ومنع retroactive mutation.
...
أنشئ `07_finish/backend_117/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
