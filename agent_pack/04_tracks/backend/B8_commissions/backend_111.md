...
نفّذ account commission override/read model مع المصدر والفعالية.
...
أنشئ `07_finish/backend_111/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
