...
| Kind | api |
| Sequence | 87 / 198 |
| Depends on | `backend_108` |

## Goal

Model percentage, fixed, and exempt policies with scope, effective dates, and versions, without a universal hardcode.
...
Create `07_finish/backend_110/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
