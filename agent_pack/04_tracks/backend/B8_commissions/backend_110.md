...
نمذج percentage/fixed/exempt policy بنطاق وتاريخ فعالية وإصدارات ومنع universal hardcode.
...
أنشئ `07_finish/backend_110/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
