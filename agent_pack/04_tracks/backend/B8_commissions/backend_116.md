...
| Kind | api |
| Sequence | 93 / 199 |
| Depends on | `backend_115` |

## Goal

Display the applied commission policy as read-only without allowing providers to modify it.
...
Create `07_finish/backend_116/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
