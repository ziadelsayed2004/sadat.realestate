...
اعرض السياسة المطبقة read-only دون السماح بتعديلها من مقدم العقار.
...
أنشئ `07_finish/backend_116/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
