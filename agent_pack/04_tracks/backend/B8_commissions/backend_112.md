...
نفّذ exceptions/waivers بمدة وسبب وموافقات وconflict validation.
...
أنشئ `07_finish/backend_112/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
