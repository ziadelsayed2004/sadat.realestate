...
| Kind | api |
| Sequence | 89 / 198 |
| Depends on | `backend_111` |

## Goal

Implement time-bounded exceptions and waivers with reasons, approvals, and conflict validation.
...
Create `07_finish/backend_112/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
