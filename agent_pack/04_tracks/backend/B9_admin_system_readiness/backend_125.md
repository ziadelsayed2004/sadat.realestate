...
نفّذ durable outbox وworker locks/retry/dead-letter للتنبيهات والـSLA والإعلانات.
...
أنشئ `07_finish/backend_125/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
