...
Implement a durable outbox plus worker locks, retry, and dead-letter handling for notifications, SLA, and ads.
...
Create `07_finish/backend_125/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
