...
Standardize public/private assets, naming, lifecycle, orphan cleanup, and retention policy.
...
Create `07_finish/backend_124/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
