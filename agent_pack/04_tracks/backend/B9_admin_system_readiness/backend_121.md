...
أكمل list/detail/create/update/disable للأدمن مع منع self-lockout وlast-super-admin deletion.
...
أنشئ `07_finish/backend_121/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
