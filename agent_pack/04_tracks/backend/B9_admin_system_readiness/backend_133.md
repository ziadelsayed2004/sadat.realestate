...
- `apps/api/src/modules/deployment/**`
- `apps/api/tests/deployment/**`
- `packages/contracts/src/deployment/**`
- `docs/api/**`
- `apps/api/openapi/**`
- `apps/api/postman/**`
- `agent_pack/**`
...
Create `07_finish/backend_133/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
