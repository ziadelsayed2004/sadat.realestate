...
جهّز multi-stage images وnon-root process وgraceful shutdown وhealthchecks وcompose للتطوير.
...
أنشئ `07_finish/backend_133/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
