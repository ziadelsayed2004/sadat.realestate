...
نفّذ build/lint/typecheck/tests/audit/inventory/security/readiness، وصنّف أي مانع كBlocked بدل إغلاقه.
...
أنشئ `07_finish/backend_138/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
