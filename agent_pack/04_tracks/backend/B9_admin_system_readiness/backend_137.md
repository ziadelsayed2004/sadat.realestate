...
Freeze v1 contracts, generated client/types, the frontend handoff, and the screen-to-endpoint matrix.
...
Create `07_finish/backend_137/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
