...
Test heavy queries, pagination limits, indexes, N+1 behavior, and payload size against documented targets.
...
Create `07_finish/backend_131/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
