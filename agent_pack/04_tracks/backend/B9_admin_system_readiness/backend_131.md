...
اختبر الاستعلامات الثقيلة وحدود pagination وindexes وN+1 والـpayload size بأهداف موثقة.
...
أنشئ `07_finish/backend_131/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
