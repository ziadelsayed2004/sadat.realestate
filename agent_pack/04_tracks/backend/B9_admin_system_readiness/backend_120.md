...
وفّر KPIs من aggregations موثقة فقط مع نطاق زمني وصلاحيات.
...
أنشئ `07_finish/backend_120/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
