...
اختبر MIME/magic bytes/path traversal/size/private access/signed expiry/orphan cleanup.
...
أنشئ `07_finish/backend_130/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
