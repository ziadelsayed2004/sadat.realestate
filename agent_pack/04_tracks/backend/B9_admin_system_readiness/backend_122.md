...
نفّذ inbox/unread/mark-read/deep links مع permission-aware projection.
...
أنشئ `07_finish/backend_122/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
