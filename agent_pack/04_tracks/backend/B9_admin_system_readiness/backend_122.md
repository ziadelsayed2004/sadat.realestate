...
Implement inbox, unread counts, mark-as-read, and deep links with permission-aware projection.
...
Create `07_finish/backend_122/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
