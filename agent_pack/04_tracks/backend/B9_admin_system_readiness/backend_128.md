...
Create deterministic UAT data for every screen state without real accounts or secrets.
...
Create `07_finish/backend_128/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
