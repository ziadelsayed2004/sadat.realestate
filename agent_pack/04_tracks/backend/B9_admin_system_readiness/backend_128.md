...
أنشئ بيانات UAT deterministic لكل حالة شاشة دون حسابات أو أسرار حقيقية.
...
أنشئ `07_finish/backend_128/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
