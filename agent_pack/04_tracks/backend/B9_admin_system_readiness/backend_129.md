...
Test authentication, RBAC, ownership, and IDOR for every sensitive route and each administrative role.
...
Create `07_finish/backend_129/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
