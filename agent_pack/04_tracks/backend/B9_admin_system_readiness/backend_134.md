...
Add metrics, log correlation, error-reporting hooks, and PII-free alerts with a runbook.
...
Create `07_finish/backend_134/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
