...
اختبر الرحلات الأساسية من التسجيل حتى النشر والطلبات والإعلانات والعمولات عبر API مع cleanup.
...
أنشئ `07_finish/backend_136/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
