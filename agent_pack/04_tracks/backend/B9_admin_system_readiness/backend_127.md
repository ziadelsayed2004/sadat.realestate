...
Build public, seeker, provider, and admin collections with positive, negative, setup, cleanup, and safe variables.
...
- `apps/api/src/modules/postman/**`
- `apps/api/tests/postman/**`
- `packages/contracts/src/postman/**`
- `docs/api/**`
- `apps/api/openapi/**`
- `apps/api/postman/**`
- `agent_pack/**`
...
Create `07_finish/backend_127/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
