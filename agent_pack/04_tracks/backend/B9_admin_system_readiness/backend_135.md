...
Review OWASP API risks and platform threats, recording evidence, gaps, and blocked checks honestly.
...
Create `07_finish/backend_135/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
