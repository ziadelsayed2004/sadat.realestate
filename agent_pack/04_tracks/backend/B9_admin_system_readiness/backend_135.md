...
راجع OWASP API ومخاطر المنصة وسجّل الأدلة والفجوات والـblocked checks بصدق.
...
أنشئ `07_finish/backend_135/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
