...
Generate a runtime endpoint inventory that matches Express, OpenAPI, permissions, and tests without presenting planned routes as implemented.
...
Create `07_finish/backend_126/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
