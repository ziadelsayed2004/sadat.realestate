...
ولّد runtime endpoint inventory يطابق Express/OpenAPI/permissions/tests ولا يوثق planned كمنفذ.
...
أنشئ `07_finish/backend_126/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
