...
| Kind | api |
| Sequence | 25 / 208 |
| Depends on | `backend_032` |

## Goal

Implement multilingual features and services with groups, ordering, activation, and links to properties and projects.
...
Create `07_finish/backend_033/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
