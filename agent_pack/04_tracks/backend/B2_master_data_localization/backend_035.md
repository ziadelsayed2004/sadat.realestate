...
Implement CMS-managed platform settings, contact information, and social links with localized values and modification history.
...
Create `07_finish/backend_035/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
