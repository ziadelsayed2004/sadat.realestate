...
اعتمد LocalizedText لـar/en/zh-CN مع fallback واتجاه آمن وفصل مفاتيح الواجهة عن محتوى CMS.
...
أنشئ `07_finish/backend_030/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
