...
Implement About blocks and Team members with ordering, publication, and public projections.
...
Create `07_finish/backend_036/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
