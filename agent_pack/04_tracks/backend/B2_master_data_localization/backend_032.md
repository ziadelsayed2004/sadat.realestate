...
نفّذ Property Categories/Types مع قواعد الربط والتفعيل والترتيب ومنع حذف مستخدم دون سياسة واضحة.
...
أنشئ `07_finish/backend_032/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
