...
Model organizations, developers, and offices, link them to providers, and implement approved source identity and verified-badge rules.
...
Create `07_finish/backend_034/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
