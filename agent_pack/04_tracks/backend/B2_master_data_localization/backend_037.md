...
نفّذ مصدرًا إداريًا موثقًا لعداد سكان السادات ونصائح العقارات دون أرقام تشغيلية وهمية.
...
أنشئ `07_finish/backend_037/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
