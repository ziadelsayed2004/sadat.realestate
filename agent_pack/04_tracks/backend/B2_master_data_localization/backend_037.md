...
| Kind | api |
| Sequence | 29 / 199 |
| Depends on | `backend_036` |

## Goal

Implement a documented administrative source for the Sadat City population counter and real-estate tips without fabricated production numbers.
...
Create `07_finish/backend_037/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
