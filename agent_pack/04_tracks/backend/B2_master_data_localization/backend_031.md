...
Implement CRUD, ordering, and activation for locations and neighborhoods with slugs, optional coordinates, and search indexes.
...
Create `07_finish/backend_031/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
