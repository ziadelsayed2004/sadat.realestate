...
Publish important transition events through an outbox with deduplication and no duplicate delivery.
...
Create `07_finish/backend_081/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
