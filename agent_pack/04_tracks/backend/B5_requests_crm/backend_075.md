...
وفّر list/details وحالتي under-review/contacted دون ملاحظات أو إسناد داخلي.
...
أنشئ `07_finish/backend_075/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
