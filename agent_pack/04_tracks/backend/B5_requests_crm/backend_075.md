...
| Kind | api |
| Sequence | 63 / 198 |
| Depends on | `backend_074` |

## Goal

Provide list and detail projections, including under-review and contacted states, without internal notes or assignment data.
...
Create `07_finish/backend_075/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
