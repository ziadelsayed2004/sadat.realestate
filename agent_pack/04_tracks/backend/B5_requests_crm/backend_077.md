...
وفّر فلاتر وبحث وإسناد وانتقالات حالة وactions مع RBAC وسجل كامل.
...
أنشئ `07_finish/backend_077/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
