...
نمذج Request بأنواع contact/viewing/search/customer مع state events وSLA وownership دون خلط الحقول الداخلية بالعامة.
...
أنشئ `07_finish/backend_070/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
