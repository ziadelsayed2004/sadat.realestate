...
نفّذ قواعد overdue قابلة للإعداد وjob idempotent وread model للإدارة.
...
أنشئ `07_finish/backend_078/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
