...
| Kind | api |
| Sequence | 62 / 198 |
| Depends on | `backend_073` |

## Goal

Allow providers to create customer requests with validation, ownership, and source attribution.
...
Create `07_finish/backend_074/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
