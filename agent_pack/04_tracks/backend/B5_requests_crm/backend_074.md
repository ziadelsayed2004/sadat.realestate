...
نفّذ إنشاء مقدم العقار لطلب عميل مع validation والملكية وsource attribution.
...
أنشئ `07_finish/backend_074/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
