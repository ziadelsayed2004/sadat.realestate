...
Implement the issue/report lifecycle, request linkage, review, resolution, reasons, and notifications.
...
Create `07_finish/backend_079/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
