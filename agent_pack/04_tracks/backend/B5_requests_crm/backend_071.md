...
| Kind | api |
| Sequence | 59 / 208 |
| Depends on | `backend_070` |

## Goal

Implement contact-request creation, tracking, and processing with spam protection and duplicate-replay prevention.
...
Create `07_finish/backend_071/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
