...
نفّذ إنشاء طلب تواصل وتتبعه ومعالجته مع منع spam وduplicate replay.
...
أنشئ `07_finish/backend_071/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
