...
Provide list, detail, and state actions for requests that are owned by or assigned to the provider only.
...
Create `07_finish/backend_076/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
