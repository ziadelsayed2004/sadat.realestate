...
Implement save-and-resume for core-data and location steps with optimistic concurrency.
...
Create `07_finish/backend_044/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
