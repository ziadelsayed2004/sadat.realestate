...
| Kind | api |
| Sequence | 36 / 188 |
| Depends on | `backend_043` |

## Goal

نفّذ حفظ واستئناف خطوات البيانات الأساسية والموقع مع optimistic concurrency.
...
أنشئ `07_finish/backend_044/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
