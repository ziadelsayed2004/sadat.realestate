...
Implement feature, service, and contact-data associations with source-identity and privacy rules.
...
Create `07_finish/backend_046/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
