...
نفّذ submit/review/needs-changes/approve/reject/publish مع سبب وتاريخ ومراجع.
...
أنشئ `07_finish/backend_041/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
