...
| Kind | api |
| Sequence | 33 / 208 |
| Depends on | `backend_040` |

## Goal

Implement submit, review, needs-changes, approve, reject, and publish transitions with reasons, timestamps, and reviewers.
...
Create `07_finish/backend_041/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
