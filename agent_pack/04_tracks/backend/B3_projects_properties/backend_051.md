...
وفّر list/filter/action summaries وavailableActions ومؤشرات الحالة لعقارات المالك فقط.
...
أنشئ `07_finish/backend_051/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
