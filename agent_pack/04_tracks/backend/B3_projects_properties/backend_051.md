...
| Kind | api |
| Sequence | 43 / 199 |
| Depends on | `backend_050` |

## Goal

Provide list, filter, action summaries, availableActions, and state indicators for the owner's properties only.
...
Create `07_finish/backend_051/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
