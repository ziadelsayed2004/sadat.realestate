...
وفّر بحثًا وفلاتر وفرزًا وصفحات وإجراءات جماعية آمنة للإدارة.
...
أنشئ `07_finish/backend_052/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
