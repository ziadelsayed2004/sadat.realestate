...
| Kind | api |
| Sequence | 44 / 188 |
| Depends on | `backend_051` |

## Goal

Provide administrative search, filters, sorting, pagination, and safe bulk actions.
...
Create `07_finish/backend_052/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
