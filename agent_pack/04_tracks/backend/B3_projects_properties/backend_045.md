...
Implement details, area, layout, price, and payment-plan fields with conditional validation.
...
Create `07_finish/backend_045/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
