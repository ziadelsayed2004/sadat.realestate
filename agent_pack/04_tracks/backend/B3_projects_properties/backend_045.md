...
| Kind | api |
| Sequence | 37 / 188 |
| Depends on | `backend_044` |

## Goal

نفّذ حقول التفاصيل والمساحات والتقسيم والسعر وخيارات السداد والتحقق الشرطي.
...
أنشئ `07_finish/backend_045/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
