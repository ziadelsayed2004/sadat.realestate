...
احفظ revisions وbefore/after ومراجعة التعديلات المنشورة دون فقد النسخة العامة الحالية.
...
أنشئ `07_finish/backend_050/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
