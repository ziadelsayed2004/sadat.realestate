...
Provide public projections for approved projects only, including their developer and linked published properties.
...
Create `07_finish/backend_042/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
