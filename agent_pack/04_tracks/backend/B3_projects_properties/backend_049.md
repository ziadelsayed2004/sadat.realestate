...
Implement administrative Needs Changes, Approve, Reject, Publish, Hide, and Archive actions with mandatory reasons.
...
Create `07_finish/backend_049/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
