...
نفّذ deterministic duplicate signals قابلة للتفسير والمراجعة ولا تدّعِ AI matching.
...
أنشئ `07_finish/backend_053/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
