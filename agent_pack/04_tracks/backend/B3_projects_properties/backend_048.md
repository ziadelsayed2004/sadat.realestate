...
| Kind | api |
| Sequence | 40 / 199 |
| Depends on | `backend_047` |

## Goal

Implement aggregate validation across all wizard steps and idempotent submission with understandable field errors.
...
Create `07_finish/backend_048/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
