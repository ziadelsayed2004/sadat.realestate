...
نفّذ validation جامعًا لكل خطوات الـwizard وإرسالًا idempotent مع field errors مفهومة.
...
أنشئ `07_finish/backend_048/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
