...
صمّم compound/text/geospatial indexes من أنماط الاستعلام الفعلية واختبر explain وحدود pagination.
...
أنشئ `07_finish/backend_055/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
