...
Design compound, text, and geospatial indexes from real query patterns and test explain plans and pagination limits.
...
Create `07_finish/backend_055/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
