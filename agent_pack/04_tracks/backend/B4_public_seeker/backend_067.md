...
| Kind | api |
| Sequence | 55 / 199 |
| Depends on | `backend_066` |

## Goal

Implement self-owned reads and updates for preferences, personal data, and account settings.
...
Create `07_finish/backend_067/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
