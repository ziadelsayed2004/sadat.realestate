...
نفّذ قراءة وتحديث التفضيلات والبيانات الشخصية وإعدادات الحساب بملكية ذاتية.
...
أنشئ `07_finish/backend_067/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
