...
Verify that internal notes, assignments, documents, and audit data never leak through public or seeker responses.
...
Create `07_finish/backend_069/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
