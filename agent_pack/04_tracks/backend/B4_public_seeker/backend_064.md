...
وفّر listing/profile عامين للجهات المعتمدة مع عقاراتها ومشروعاتها المنشورة.
...
أنشئ `07_finish/backend_064/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
