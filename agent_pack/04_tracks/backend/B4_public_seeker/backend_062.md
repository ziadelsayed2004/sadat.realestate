...
وفّر تفاصيل published فقط بslug وSEO/source identity/project/media وrelated items دون حقول داخلية.
...
أنشئ `07_finish/backend_062/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
