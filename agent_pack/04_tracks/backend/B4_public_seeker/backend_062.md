...
| Kind | api |
| Sequence | 50 / 208 |
| Depends on | `backend_061` |

## Goal

Provide published-only property details by slug with SEO, source identity, project, media, and related items without internal fields.
...
Create `07_finish/backend_062/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
