...
وفّر home feed منشورًا فقط يشمل أقسام CMS والعقارات والمطورين والمحتوى والبانرات وفق الترتيب.
...
أنشئ `07_finish/backend_060/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
