...
نفّذ inbox/pagination/unread/mark-read/preferences وإسقاط الروابط الآمنة.
...
أنشئ `07_finish/backend_068/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
