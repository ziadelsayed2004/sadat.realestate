...
| Kind | api |
| Sequence | 56 / 208 |
| Depends on | `backend_067` |

## Goal

Implement inbox, pagination, unread counts, mark-as-read, preferences, and safe link projections.
...
Create `07_finish/backend_068/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
