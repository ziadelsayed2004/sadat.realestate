...
Implement idempotent save, unsave, and list behavior for seekers with safe projection when a property's state changes.
...
Create `07_finish/backend_065/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
