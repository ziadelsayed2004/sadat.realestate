...
Implement comparison for at most two items with fixed comparison fields and published/available validation.
...
Create `07_finish/backend_063/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
