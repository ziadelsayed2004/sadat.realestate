...
| Kind | api |
| Sequence | 70 / 199 |
| Depends on | `backend_081` |

## Goal

Implement CRUD, ordering, and activation for multilingual ArticleCategory records.
...
Create `07_finish/backend_090/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
