...
وفّر listing/detail published فقط بslug واللغة والـSEO.
...
أنشئ `07_finish/backend_092/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
