...
اختبر fallback والترجمات والنص الطويل والـslug uniqueness وعدم خلط المحتوى الإداري بالعام.
...
أنشئ `07_finish/backend_097/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
