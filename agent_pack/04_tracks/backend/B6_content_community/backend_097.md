...
Test fallbacks, translations, long text, slug uniqueness, and separation between administrative and public content.
...
- `packages/contracts/src/quality/**`
- `docs/api/**`
- `apps/api/openapi/**`
- `apps/api/postman/**`
- `agent_pack/**`
...
Create `07_finish/backend_097/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
