...
Implement report, review, hide, and restore actions with reasons, audit, and abuse prevention.
...
Create `07_finish/backend_095/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
