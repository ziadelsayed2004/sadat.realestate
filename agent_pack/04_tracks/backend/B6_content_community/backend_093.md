...
نفّذ create/list/edit/delete المملوك مع moderation status وlimits.
...
أنشئ `07_finish/backend_093/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
