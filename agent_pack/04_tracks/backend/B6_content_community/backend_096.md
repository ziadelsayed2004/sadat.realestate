...
وفّر feed آمنًا مع pagination وأعداد صحيحة وحالات حذف/إخفاء واضحة.
...
أنشئ `07_finish/backend_096/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
