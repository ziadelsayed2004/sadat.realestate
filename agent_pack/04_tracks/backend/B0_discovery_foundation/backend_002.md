# backend_002 — Bootstrap Express and TypeScript
...
Prepare an API application with clear layers, correct startup and shutdown behavior, strict TypeScript, and build/dev/start commands.
...
Create `07_finish/backend_002/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
