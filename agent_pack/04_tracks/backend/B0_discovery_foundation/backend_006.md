...
فعّل Helmet/CORS/body limits/rate limits/sanitization وسياسة proxy واضحة مع اختبارات الضبط الأمني.
...
أنشئ `07_finish/backend_006/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
