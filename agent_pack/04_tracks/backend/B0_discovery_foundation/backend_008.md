...
جهّز unit/integration/API test harness وlint/typecheck/coverage وCI أساسي قابل للتشغيل محليًا.
...
أنشئ `07_finish/backend_008/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
