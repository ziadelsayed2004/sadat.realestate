# backend_000 — جرد حقيقة المستودع وتثبيت القرارات
...
افحص المستودع الفعلي، سجّل الموجود والناقص، ثبّت الافتراضات والقرارات المفتوحة، ولا تدّعي وجود Runtime غير مرفق.
...
أنشئ `07_finish/backend_000/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
