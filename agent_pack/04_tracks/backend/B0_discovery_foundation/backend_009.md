...
أنشئ OpenAPI 3.1 وPostman environment/collection scaffold مربوطين بـ/api/v1 دون توثيق endpoints غير منفذة.
...
أنشئ `07_finish/backend_009/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
