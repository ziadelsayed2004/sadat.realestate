...
أضف trace/request IDs وسجلات structured مع redaction ومنع تسريب PII أو tokens.
...
أنشئ `07_finish/backend_007/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
