...
وحّد schemas والتحقق وأنواع DTO والاستجابات والأخطاء بين API والواجهة في packages/contracts.
...
أنشئ `07_finish/backend_005/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
