# backend_004 — MongoDB Connectivity, Health, and Seed
...
| Kind | infrastructure |
| Sequence | 5 / 198 |
| Depends on | `backend_003` |

## Goal

Create the MongoDB connection layer, health and readiness behavior, index policy, and repeatable development-only seed data.
...
Create `07_finish/backend_004/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
