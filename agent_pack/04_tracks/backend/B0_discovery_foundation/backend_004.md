...
أنشئ طبقة اتصال MongoDB، health/readiness، سياسة indexes، وseed قابل للتكرار لبيانات التطوير فقط.
...
أنشئ `07_finish/backend_004/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
