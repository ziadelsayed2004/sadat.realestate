...
أضف object-level authorization وإسقاط availableActions من الخادم حسب الدور والحالة والملكية.
...
أنشئ `07_finish/backend_018/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
