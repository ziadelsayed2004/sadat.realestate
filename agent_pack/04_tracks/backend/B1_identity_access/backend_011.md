...
نفّذ password login عند الحاجة وaccess/opaque refresh rotation وlogout/reuse detection وسياسة cookies الآمنة.
...
أنشئ `07_finish/backend_011/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
