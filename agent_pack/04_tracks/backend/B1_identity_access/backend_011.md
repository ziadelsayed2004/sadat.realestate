...
Implement password login where required, access tokens, opaque refresh rotation, logout, reuse detection, and secure cookie policy.
...
Create `07_finish/backend_011/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
