...
Implement private-document upload with type, size, and signature checks plus authorized reads without permanent public URLs.
...
Create `07_finish/backend_015/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
