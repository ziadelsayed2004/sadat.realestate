...
نفّذ رفع المستندات الخاصة وفحص النوع والحجم والتوقيع وتفويض القراءة دون public permanent URLs.
...
أنشئ `07_finish/backend_015/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
