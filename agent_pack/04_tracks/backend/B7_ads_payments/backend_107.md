...
| Kind | api |
| Sequence | 85 / 188 |
| Depends on | `backend_106` |

## Goal

وفّر history/status/quote/payment/schedule projection للمالك فقط.
...
أنشئ `07_finish/backend_107/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
