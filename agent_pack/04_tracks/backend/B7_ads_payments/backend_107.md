...
Provide owner-only history, state, quote, payment, and schedule projections.
...
Create `07_finish/backend_107/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
