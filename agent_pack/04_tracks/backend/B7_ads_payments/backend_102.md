...
| Kind | api |
| Sequence | 80 / 199 |
| Depends on | `backend_101` |

## Goal

Implement administrative quotes with amount, currency, validity, clear terms, and decision history.
...
Create `07_finish/backend_102/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
