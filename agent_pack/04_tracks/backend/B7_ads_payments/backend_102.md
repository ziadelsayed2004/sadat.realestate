...
نفّذ admin quote بقيمة/عملة/صلاحية وبنود واضحة وتاريخ قرار.
...
أنشئ `07_finish/backend_102/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
