...
| Kind | api |
| Sequence | 84 / 199 |
| Depends on | `backend_105` |

## Goal

Implement banner and media CRUD, preview, scheduling, publication by placement, and ordering.
...
Create `07_finish/backend_106/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
