...
نفّذ CRUD وpreview وجدولة ونشر Banner/media عبر placement مع ترتيب.
...
أنشئ `07_finish/backend_106/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
