...
وفّر تقارير قابلة للتصفية دون خلط إثبات الدفع بالموافقة البنكية أو الإيراد المحقق.
...
أنشئ `07_finish/backend_108/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
