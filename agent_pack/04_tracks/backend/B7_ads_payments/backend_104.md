...
نفّذ approve/reject مع reason وRBAC وidempotency وaudit.
...
أنشئ `07_finish/backend_104/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
