...
نمذج AdPlacement وavailability/settings دون سعر عام hardcoded.
...
أنشئ `07_finish/backend_100/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
