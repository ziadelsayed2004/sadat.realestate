...
نفّذ draft/review/waiting-pricing/quote workflow وملكية مقدم العقار.
...
أنشئ `07_finish/backend_101/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
