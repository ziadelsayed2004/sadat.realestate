...
نفّذ Scheduled/Active/Ended transitions مع timezone مصر ومنع تعارض placement.
...
أنشئ `07_finish/backend_105/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
