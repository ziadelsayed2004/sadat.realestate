...
| Kind | api |
| Sequence | 83 / 188 |
| Depends on | `backend_104` |

## Goal

Implement Scheduled, Active, and Ended transitions in the Egypt timezone while preventing placement conflicts.
...
Create `07_finish/backend_105/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
