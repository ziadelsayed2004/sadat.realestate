...
نفّذ login وإرسال/إعادة OTP والتحقق والـcooldown والأخطاء.
...
أنشئ `07_finish/frontend_020/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
