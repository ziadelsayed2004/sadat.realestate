...
نفّذ variants التسجيل والتحقق والنجاح مع حفظ آمن للمرحلة.
...
أنشئ `07_finish/frontend_021/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
