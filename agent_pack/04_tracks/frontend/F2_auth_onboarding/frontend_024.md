...
Implement business/developer variants and private-document upload with all required states.
...
Create `07_finish/frontend_024/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
