...
Review every AUTH screen across desktop, tablet, mobile, directions, validation, and resume behavior.
...
Create `07_finish/frontend_026/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
