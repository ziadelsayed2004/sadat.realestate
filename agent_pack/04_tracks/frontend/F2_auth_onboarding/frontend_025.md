...
نفّذ review/submit/under-review/tracking/needs-info/approved.
...
أنشئ `07_finish/frontend_025/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
