...
ثبّت canonical/meta/structured data/sitemap/robots/hydration واختبر crawlable HTML.
...
أنشئ `07_finish/frontend_018/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
