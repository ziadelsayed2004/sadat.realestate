...
Implement canonical links, metadata, structured data, sitemap, robots, and hydration, and verify crawlable HTML.
...
Create `07_finish/frontend_018/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
