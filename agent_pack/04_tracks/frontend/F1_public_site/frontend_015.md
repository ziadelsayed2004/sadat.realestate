...
نفّذ القائمة والتصنيف والتفاصيل وmetadata متعددة اللغات.
...
أنشئ `07_finish/frontend_015/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
