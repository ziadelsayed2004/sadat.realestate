...
| Kind | frontend |
| Sequence | 130 / 197 |
| Depends on | `frontend_014` |

## Goal

Implement article listing, categories, details, and multilingual metadata.
...
- Screen ID `PUB-07` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
- Screen ID `PUB-08` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_015/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
