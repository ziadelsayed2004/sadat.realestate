...
| Kind | frontend |
| Sequence | 127 / 199 |
| Depends on | `frontend_010` |

## Goal

Implement filters, sorting, search, pagination, states, and query-string synchronization.
...
- Screen ID `PUB-02` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_011/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
