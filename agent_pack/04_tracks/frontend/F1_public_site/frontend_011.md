...
نفّذ الفلاتر والفرز والبحث والصفحات والحالات ومزامنة query string.
...
أنشئ `07_finish/frontend_011/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
