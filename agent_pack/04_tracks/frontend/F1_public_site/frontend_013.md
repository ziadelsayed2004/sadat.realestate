...
| Kind | frontend |
| Sequence | 129 / 198 |
| Depends on | `frontend_012` |

## Goal

Implement comparison for two items only with fixed fields and removal/unavailable states.
...
- Screen ID `PUB-04` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_013/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
