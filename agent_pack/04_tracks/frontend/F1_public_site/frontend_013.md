...
نفّذ مقارنة عنصرين فقط وحقول ثابتة وحالات إزالة/عدم توفر.
...
أنشئ `07_finish/frontend_013/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
