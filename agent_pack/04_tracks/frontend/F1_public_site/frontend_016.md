...
| Kind | frontend |
| Sequence | 131 / 197 |
| Depends on | `frontend_015` |

## Goal

Implement the feed, comments, reports, and post-creation modal with authentication guards.
...
Create `07_finish/frontend_016/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
