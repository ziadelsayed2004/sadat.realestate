...
نفّذ feed والتعليقات والبلاغات وmodal الإنشاء مع حراسة الدخول.
...
أنشئ `07_finish/frontend_016/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
