...
Implement the directory, profiles, and approved properties and projects.
...
Create `07_finish/frontend_014/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
