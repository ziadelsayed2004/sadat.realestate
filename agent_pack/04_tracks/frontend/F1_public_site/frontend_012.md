...
نفّذ المعرض والتفاصيل والمصدر والمطور والمشروع والـSEO وطلب التواصل/المعاينة.
...
أنشئ `07_finish/frontend_012/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
