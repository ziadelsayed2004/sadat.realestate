...
Implement the gallery, details, source, developer, project, SEO, and contact/viewing request actions.
...
- Screen ID `PUB-03` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_012/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
