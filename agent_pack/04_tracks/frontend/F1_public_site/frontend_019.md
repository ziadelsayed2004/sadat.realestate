...
Review desktop, tablet, and mobile behavior, all supported locales, visual fidelity, and states for every PUB screen.
...
Create `07_finish/frontend_019/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
