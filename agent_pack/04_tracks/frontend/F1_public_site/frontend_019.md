...
راجع Desktop/Tablet/Mobile وAR/EN/ZH-CN والـvisual fidelity والحالات لكل PUB.
...
أنشئ `07_finish/frontend_019/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
