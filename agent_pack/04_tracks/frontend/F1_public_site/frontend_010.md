...
نفّذ الصفحة الرئيسية من الـCMS وread model مع SSR وresponsive كامل.
...
أنشئ `07_finish/frontend_010/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
