...
Review desktop scope, ownership, uploads, wizard, resume behavior, and every PRV state.
...
Create `07_finish/frontend_051/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
