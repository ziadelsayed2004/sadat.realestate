...
راجع Desktop والملكية والرفع والـwizard والاستئناف وكل حالات PRV.
...
أنشئ `07_finish/frontend_051/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
