...
| Kind | frontend |
| Sequence | 150 / 199 |
| Depends on | `frontend_036` |

## Goal

Implement the desktop shell, KPIs, and real states.
...
- Screen ID `PRV-01` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_040/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
