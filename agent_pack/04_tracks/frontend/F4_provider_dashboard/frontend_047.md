...
| Kind | frontend |
| Sequence | 157 / 198 |
| Depends on | `frontend_046` |

## Goal

Implement the CRM list, creation modal, and states.
...
Create `07_finish/frontend_047/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
