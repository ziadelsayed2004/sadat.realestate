...
| Kind | frontend |
| Sequence | 155 / 197 |
| Depends on | `frontend_045` |

## Goal

Implement provider project listing and management according to the contracts.
...
- Screen ID `PRV-15` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_046/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
