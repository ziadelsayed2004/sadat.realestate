...
| Kind | frontend |
| Sequence | 151 / 199 |
| Depends on | `frontend_040` |

## Goal

Implement listing, filters, and actions according to ownership and state.
...
- Screen ID `PRV-02` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_041/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
