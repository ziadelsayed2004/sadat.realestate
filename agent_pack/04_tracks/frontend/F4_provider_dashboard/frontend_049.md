...
نفّذ ad workflow وpayment proof وعرض سياسة العمولة read-only.
...
أنشئ `07_finish/frontend_049/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
