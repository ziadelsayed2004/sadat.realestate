...
| Kind | frontend |
| Sequence | 153 / 188 |
| Depends on | `frontend_044` |

## Goal

Implement validation errors, submitted, rejected, and published states with next actions.
...
Create `07_finish/frontend_045/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
