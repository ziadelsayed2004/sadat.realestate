...
نفّذ validation errors/submitted/rejected/published وnext actions.
...
أنشئ `07_finish/frontend_045/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
