...
| Kind | frontend |
| Sequence | 156 / 188 |
| Depends on | `frontend_047` |

## Goal

Implement the list, calendar, and allowed actions.
...
- Screen ID `PRV-18` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_048/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
