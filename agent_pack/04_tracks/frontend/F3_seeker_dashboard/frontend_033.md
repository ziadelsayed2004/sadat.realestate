...
| Kind | frontend |
| Sequence | 155 / 208 |
| Depends on | `frontend_032` |

## Goal

Implement the list, removal, and unavailable-property states.
...
- Screen ID `SEK-06` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_033/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
