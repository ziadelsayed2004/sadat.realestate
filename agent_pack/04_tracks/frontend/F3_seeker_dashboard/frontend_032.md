...
نفّذ المواعيد والحالات وإعادة الجدولة/الإلغاء حسب availableActions.
...
أنشئ `07_finish/frontend_032/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
