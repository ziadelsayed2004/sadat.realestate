...
Implement appointments, states, rescheduling, and cancellation according to availableActions.
...
- Screen ID `SEK-05` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_032/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
