...
راجع نطاق Desktop فقط والصلاحيات ومنع ظهور internal data والحالات.
...
أنشئ `07_finish/frontend_036/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
