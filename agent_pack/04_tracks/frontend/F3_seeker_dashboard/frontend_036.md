...
Review the desktop-only scope, permissions, prevention of internal-data exposure, and all required states.
...
Create `07_finish/frontend_036/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
