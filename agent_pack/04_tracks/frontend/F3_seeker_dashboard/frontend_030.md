...
| Kind | frontend |
| Sequence | 143 / 199 |
| Depends on | `frontend_026` |

## Goal

Implement the desktop shell and overview using actual data.
...
- Screen ID `SEK-01` through `09_sources/DESIGN_SOURCE_MANIFEST.json`.
...
Create `07_finish/frontend_030/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
