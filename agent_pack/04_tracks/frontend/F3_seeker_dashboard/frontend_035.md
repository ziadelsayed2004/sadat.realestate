...
| Kind | frontend |
| Sequence | 147 / 197 |
| Depends on | `frontend_034` |

## Goal

Implement tabs for preferences, personal data, and account settings.
...
Create `07_finish/frontend_035/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
