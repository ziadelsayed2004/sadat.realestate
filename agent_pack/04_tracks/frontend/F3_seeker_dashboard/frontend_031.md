...
| Kind | frontend |
| Sequence | 153 / 208 |
| Depends on | `frontend_030` |

## Goal

Implement the list and under-review/contacted details with safe projections.
...
Create `07_finish/frontend_031/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
