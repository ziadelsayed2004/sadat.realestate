...
نفّذ القائمة وتفاصيل under-review/contacted مع إسقاط آمن.
...
أنشئ `07_finish/frontend_031/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
