...
Prepare Vitest, React Testing Library, MSW, Playwright, and visual snapshots across approved viewports and locales.
...
Create `07_finish/frontend_009/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
