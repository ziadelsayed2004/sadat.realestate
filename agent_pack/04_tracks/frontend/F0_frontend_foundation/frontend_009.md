...
جهّز Vitest/RTL/MSW/Playwright وvisual snapshots عبر المقاسات واللغات.
...
أنشئ `07_finish/frontend_009/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
