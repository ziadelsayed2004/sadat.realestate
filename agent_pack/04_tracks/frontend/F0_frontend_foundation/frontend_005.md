...
نفّذ access-token memory/refresh flow وrole guards وavailableActions وlogout متعدد التبويبات.
...
أنشئ `07_finish/frontend_005/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
