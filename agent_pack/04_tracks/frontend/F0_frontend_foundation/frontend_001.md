...
| Kind | frontend |
| Sequence | 115 / 188 |
| Depends on | `frontend_000` |

## Goal

اربط assets النهائية وأنشئ tokens للون والخط والمسافة والradius والظلال دون إعادة رسم الشعارات.
...
أنشئ `07_finish/frontend_001/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
