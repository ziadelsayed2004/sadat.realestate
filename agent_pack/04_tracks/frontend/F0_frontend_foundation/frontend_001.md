...
Connect final assets and create color, typography, spacing, radius, and shadow tokens without redrawing logos.
...
Create `07_finish/frontend_001/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
