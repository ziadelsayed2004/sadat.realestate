...
جهّز React + TypeScript + Vite SSR للموقع العام مع SPA shells للوحات وبناءات dev/production منفصلة.
...
أنشئ `07_finish/frontend_000/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
