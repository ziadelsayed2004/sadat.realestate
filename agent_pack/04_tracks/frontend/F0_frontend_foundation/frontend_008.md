...
Implement keyboard access, focus, labels, contrast, reduced motion, and only the approved responsive ranges.
...
Create `07_finish/frontend_008/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
