...
طبّق keyboard/focus/labels/contrast/reduced-motion ونطاقات responsive المعتمدة فقط.
...
أنشئ `07_finish/frontend_008/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
