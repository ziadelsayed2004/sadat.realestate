...
Implement ar, en, and zh-CN with unified keys, persisted locale, safe RTL handling, and a CJK-capable font.
...
Create `07_finish/frontend_006/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
