...
نفّذ ar/en/zh-CN بمفاتيح موحدة وحفظ locale وRTL آمن وخط يدعم CJK.
...
أنشئ `07_finish/frontend_006/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
