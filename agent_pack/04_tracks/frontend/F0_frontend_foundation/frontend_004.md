...
Consume generated contracts and client types, and add query caching, request IDs, cancellation, and retry without duplicated types.
...
Create `07_finish/frontend_004/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
