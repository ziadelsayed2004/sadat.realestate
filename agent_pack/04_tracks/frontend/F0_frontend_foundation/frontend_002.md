...
| Kind | frontend |
| Sequence | 127 / 208 |
| Depends on | `frontend_001` |

## Goal

Implement Buttons, Inputs, Selects, Tabs, Badges, Modals, Toasts, Tables, Pagination, and PropertyCard with their required states.
...
Create `07_finish/frontend_002/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
