...
أنشئ patterns موحدة للتحميل والفراغ والخطأ وإعادة المحاولة والصورة المفقودة والنص الطويل.
...
أنشئ `07_finish/frontend_007/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
