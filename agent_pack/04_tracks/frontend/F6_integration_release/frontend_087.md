...
جهّز production builds للـAPI والـSSR/static assets وpreview مع env آمنة وsmoke tests.
...
أنشئ `07_finish/frontend_087/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
