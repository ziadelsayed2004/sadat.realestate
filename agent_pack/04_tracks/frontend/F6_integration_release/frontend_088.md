...
وثّق local setup والبيئات والroutes والأدوار وtroubleshooting وrollback.
...
أنشئ `07_finish/frontend_088/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
