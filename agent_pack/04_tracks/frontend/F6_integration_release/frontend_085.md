...
Review CSP, XSS, CSRF, token storage, open redirects, upload UI, and cache privacy.
...
Create `07_finish/frontend_085/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
