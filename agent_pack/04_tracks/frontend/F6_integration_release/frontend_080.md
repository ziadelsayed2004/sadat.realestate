...
اختبر التسجيل والنشر والبحث والحفظ والطلبات والمعاينة والإعلانات والعمولات والإدارة.
...
أنشئ `07_finish/frontend_080/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
