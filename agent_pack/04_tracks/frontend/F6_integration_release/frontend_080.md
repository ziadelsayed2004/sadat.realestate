...
Test registration, publication, search, save, requests, viewings, ads, commissions, and administration.
...
Create `07_finish/frontend_080/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
