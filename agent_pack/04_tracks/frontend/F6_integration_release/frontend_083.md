...
نفّذ automated/manual WCAG checks للوحة المفاتيح والتركيز والـscreen reader والتباين.
...
أنشئ `07_finish/frontend_083/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
