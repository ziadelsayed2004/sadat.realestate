...
| Kind | quality |
| Sequence | 184 / 199 |
| Depends on | `frontend_083` |

## Goal

Test SSR, hydration, bundles, images, and lazy routes, and document budgets and measured results.
...
- `apps/web/src/features/performance/**`
- `apps/web/src/routes/**`
- `apps/web/tests/**`
- `packages/ui/**`
- `packages/contracts/**`
...
Create `07_finish/frontend_084/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
