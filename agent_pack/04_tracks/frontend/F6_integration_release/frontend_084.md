...
اختبر SSR/hydration/bundles/images/lazy routes ووثّق budgets ونتائج حقيقية.
...
أنشئ `07_finish/frontend_084/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
