...
| Kind | release |
| Sequence | 187 / 188 |
| Depends on | `frontend_088` |

## Goal

Run the UAT matrix for all 131 screens and close Severity 1/2 defects or record an approved blocker.
...
Create `07_finish/frontend_089/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
