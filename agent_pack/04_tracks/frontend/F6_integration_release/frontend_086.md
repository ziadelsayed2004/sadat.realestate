...
تحقق أن كل شاشة تستخدم endpoint منفذًا وfixture قابلة للتكرار بلا mocks إنتاجية.
...
أنشئ `07_finish/frontend_086/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
