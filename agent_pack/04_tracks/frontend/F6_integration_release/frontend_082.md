...
Test ar, en, and zh-CN, long text, dates, numbers, currency, and locale persistence.
...
Create `07_finish/frontend_082/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
