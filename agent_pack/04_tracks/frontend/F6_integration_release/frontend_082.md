...
| Kind | quality |
| Sequence | 180 / 188 |
| Depends on | `frontend_081` |

## Goal

اختبر ar/en/zh-CN والنص الطويل والتواريخ والأرقام والعملة وحفظ locale.
...
- `apps/web/src/features/localization/**`
- `apps/web/src/routes/**`
- `apps/web/tests/**`
- `packages/ui/**`
- `packages/contracts/**`
...
أنشئ `07_finish/frontend_082/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
