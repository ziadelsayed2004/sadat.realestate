...
| Kind | quality |
| Sequence | 180 / 197 |
| Depends on | `frontend_080` |

## Goal

Compare every Screen ID with its approved reference, record differences, and block acceptance for critical deviations.
...
Create `07_finish/frontend_081/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
