...
قارن كل Screen ID بالمرجع المعتمد وسجّل الفروق ويمنع القبول مع انحرافات حرجة.
...
أنشئ `07_finish/frontend_081/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
