...
نفّذ السياسات والسجل والحساب والاستثناء والconfirmations.
...
أنشئ `07_finish/frontend_071/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
