...
| Kind | frontend |
| Sequence | 170 / 188 |
| Depends on | `frontend_069` |

## Goal

نفّذ workflow والتسعير والإثباتات والتقويم والمراجعة.
...
- `apps/web/src/features/admin_ads/**`
- `apps/web/src/routes/**`
- `apps/web/tests/**`
- `packages/ui/**`
- `packages/contracts/**`
...
أنشئ `07_finish/frontend_070/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
