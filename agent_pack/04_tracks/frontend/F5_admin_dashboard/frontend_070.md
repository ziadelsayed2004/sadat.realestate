...
Implement the workflow, pricing, proofs, calendar, and review interfaces.
...
Create `07_finish/frontend_070/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
