...
Implement multilingual forms and concurrency-safe saves.
...
Create `07_finish/frontend_073/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
