...
| Kind | frontend |
| Sequence | 173 / 188 |
| Depends on | `frontend_072` |

## Goal

نفّذ forms متعددة اللغات والحفظ المتزامن.
...
أنشئ `07_finish/frontend_073/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
