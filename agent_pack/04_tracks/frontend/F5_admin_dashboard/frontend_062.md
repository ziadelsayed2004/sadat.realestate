...
نفّذ القوائم والتفاصيل والقيود مع reasons وbefore/after.
...
أنشئ `07_finish/frontend_062/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
