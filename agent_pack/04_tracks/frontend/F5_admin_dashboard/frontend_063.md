...
Implement CRUD, ordering, and activation for all three modules.
...
Create `07_finish/frontend_063/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
