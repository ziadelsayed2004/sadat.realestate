...
| Area | admin_master_data |
| Kind | frontend |
| Sequence | 163 / 188 |
| Depends on | `frontend_062` |

## Goal

نفّذ CRUD/ordering/activation للموديولات الثلاثة.
...
- `apps/web/src/features/admin_master_data/**`
- `apps/web/src/routes/**`
- `apps/web/tests/**`
- `packages/ui/**`
- `packages/contracts/**`
...
أنشئ `07_finish/frontend_063/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
