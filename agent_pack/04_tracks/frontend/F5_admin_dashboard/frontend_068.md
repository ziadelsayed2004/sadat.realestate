...
| Area | admin_community |
| Kind | frontend |
| Sequence | 168 / 188 |
| Depends on | `frontend_067` |

## Goal

نفّذ moderation actions وreasons وfilters.
...
- `apps/web/src/features/admin_community/**`
- `apps/web/src/routes/**`
- `apps/web/tests/**`
- `packages/ui/**`
- `packages/contracts/**`
...
أنشئ `07_finish/frontend_068/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
