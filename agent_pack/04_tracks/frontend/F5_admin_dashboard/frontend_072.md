...
| Kind | frontend |
| Sequence | 172 / 188 |
| Depends on | `frontend_071` |

## Goal

نفّذ البانرات والإضافة والنصائح وترتيب الصفحة ومعاينتها.
...
- `apps/web/src/features/admin_home/**`
- `apps/web/src/routes/**`
- `apps/web/tests/**`
- `packages/ui/**`
- `packages/contracts/**`
...
أنشئ `07_finish/frontend_072/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
