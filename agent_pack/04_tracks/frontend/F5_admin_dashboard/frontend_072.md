...
Implement banners, creation, tips, homepage ordering, and preview.
...
Create `07_finish/frontend_072/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
