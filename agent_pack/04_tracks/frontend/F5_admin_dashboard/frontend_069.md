...
| Kind | frontend |
| Sequence | 169 / 188 |
| Depends on | `frontend_068` |

## Goal

نفّذ CMS forms والترتيب والمعاينة.
...
أنشئ `07_finish/frontend_069/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
