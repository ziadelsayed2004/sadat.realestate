...
Implement CMS forms, ordering, and preview.
...
Create `07_finish/frontend_069/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
