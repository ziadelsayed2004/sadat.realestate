...
نفّذ layout المكتبي والتنقل والoverview والـpermission gating.
...
أنشئ `07_finish/frontend_060/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
