...
Implement inbox plus audit filters, details, and before/after views.
...
Create `07_finish/frontend_076/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
