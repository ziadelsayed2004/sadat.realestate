...
Test approved roles, View Only, sensitive actions, and desktop fidelity for every ADM screen.
...
Create `07_finish/frontend_077/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
