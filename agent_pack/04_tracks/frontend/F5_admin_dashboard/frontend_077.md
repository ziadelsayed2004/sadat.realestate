...
اختبر الأدوار المعتمدة وView Only والأفعال الحساسة وDesktop fidelity لكل ADM.
...
أنشئ `07_finish/frontend_077/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
