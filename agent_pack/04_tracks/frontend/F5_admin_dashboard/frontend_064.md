...
| Kind | frontend |
| Sequence | 164 / 188 |
| Depends on | `frontend_063` |

## Goal

نفّذ list/detail/review actions والحالات.
...
- `apps/web/src/features/admin_projects/**`
- `apps/web/src/routes/**`
- `apps/web/tests/**`
- `packages/ui/**`
- `packages/contracts/**`
...
أنشئ `07_finish/frontend_064/completion.json`، ثم استخدم status tool وشغّل sync/audit/selector وتوقف.
