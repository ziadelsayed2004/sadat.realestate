...
Implement list, detail, review actions, and states.
...
Create `07_finish/frontend_064/completion.json`, then use the status tool and run sync, audit, and selector. Stop after this task.
