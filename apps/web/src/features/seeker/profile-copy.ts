...
const copy: Readonly<Record<SupportedLocale, SeekerProfileCopy>> = {
  ar: {
    ...
    description: 'أدر بياناتك الشخصية وتفضيلات البحث',
