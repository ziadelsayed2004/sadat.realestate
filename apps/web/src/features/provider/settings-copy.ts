...
const copy: Readonly<Record<SupportedLocale, ProviderSettingsCopy>> = {
  ar: {
    eyebrow: 'مساحة المزوّد', title: 'الإعدادات', description: 'إدارة إعدادات حسابك وبيانات التواصل والأمان.', tabs: { account: 'بيانات الحساب', contact: 'بيانات التواصل', security: 'الأمان' },
    ...
    security: { heading: 'الأمان', password: 'تغيير كلمة المرور', current: 'كلمة المرور الحالية', next: 'كلمة المرور الجديدة', confirm: 'تأكيد كلمة المرور', update: 'تحديث كلمة المرور', deleteHeading: 'منطقة الخطر', deleteBody: 'طلب حذف الحساب غير متاح من خلال هذه الواجهة حاليًا.', deleteAction: 'طلب حذف الحساب', unavailable: 'غير متاح حاليًا' },
  ...
  en: {
    eyebrow: 'Provider workspace', title: 'Settings', description: 'Manage your account settings, contact details, and security.', tabs: { account: 'Account data', contact: 'Contact data', security: 'Security' },
    ...
    security: { heading: 'Security', password: 'Change password', current: 'Current password', next: 'New password', confirm: 'Confirm password', update: 'Update password', deleteHeading: 'Danger zone', deleteBody: 'Account deletion requests are not available from this interface yet.', deleteAction: 'Request account deletion', unavailable: 'Currently unavailable' },
...
export function getProviderSettingsCopy(locale: SupportedLocale): ProviderSettingsCopy {
  return localizeCopy('provider/settings-copy#getProviderSettingsCopy', locale, copy[locale]);
}
