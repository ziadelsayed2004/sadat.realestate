...
const statuses = {
  ...
  en: { draft: 'Draft', pending_review: 'Pending review', needs_changes: 'Needs changes', approved: 'Approved', published: 'Published', rejected: 'Rejected', hidden: 'Hidden', archived: 'Archived' },
  'zh-CN': { draft: '草稿', pending_review: '待审核', needs_changes: '需要修改', approved: '已批准', published: '已发布', rejected: '已拒绝', hidden: '已隐藏', archived: '已归档' }
} as const satisfies Readonly<Record<SupportedLocale, Readonly<Record<ProjectStatus, string>>>>;
...
const copy: Readonly<Record<SupportedLocale, ProviderProjectsCopy>> = {
  ...
  'zh-CN': {
    eyebrow: '项目管理', title: '项目', description: '管理提供方账户拥有的项目，并查看状态和服务器授权的操作。', add: '添加新项目', countSuffix: '个项目',
    filtersLabel: '筛选项目', searchLabel: '搜索', searchPlaceholder: '按项目名称或短链接搜索', statusLabel: '状态', allStatuses: '全部状态', apply: '应用', clear: '清除筛选', emptyTitle: '暂无项目', emptyBody: '提供方账户拥有的项目将在可用时显示在这里。', noResultsTitle: '没有匹配的项目', noResultsBody: '请尝试更改搜索或状态筛选。',
    columns: { project: '项目', slug: '短链接', status: '状态', reason: '审核备注', updated: '更新时间', actions: '操作' }, statuses: statuses['zh-CN'], viewUnavailable: '详细视图不可用', edit: '编辑', submit: '提交审核', noActions: '没有可用操作', reason: '原因：',
    form: { createTitle: '添加新项目', editTitle: '编辑项目', createDescription: '填写当前项目合同支持的字段。', editDescription: '编辑提供方拥有的字段并保留服务器版本。', name: '项目名称', description: '描述', slug: '短链接', locationId: '位置 ID', organizationId: '机构 ID', website: '网站', reason: '变更原因', reasonHelp: '敏感变更必填，并会随操作记录。', save: '保存', cancel: '取消', close: '关闭', required: '必填', localeLabels: { ar: '阿拉伯语', en: '英语', 'zh-CN': '简体中文' }, placeholders: { slug: 'central-project', locationId: '可选 ID', organizationId: '可选 ID', website: 'https://example.com' } },
    submitDialog: { title: '提交项目审核', description: '项目将以当前状态和版本发送到审核流程。', reason: '提交原因', reasonHelp: '请输入至少 5 个字符的明确原因。', confirm: '提交', cancel: '取消' },
    feedback: { created: '项目已创建。', updated: '项目已更新。', submitted: '项目已提交审核。' }, errors: { validation: '保存前请检查必填字段。', generic: '无法保存更改，请重试。', conflict: '服务器上的项目已发生变化。请重新加载列表后再试。' }, pagination: '项目分页', previous: '上一页', next: '下一页'
  }
};
