...
const copies: Readonly<Record<SupportedLocale, AuthCopy>> = {
  ar: {
    ...
    phoneLoginPrompt: 'أو تابع باستخدام رقم الهاتف',
    phoneLoginAction: 'تأكيد رقم الهاتف',
    phoneTitle: 'تأكيد رقم الهاتف',
    phoneDescription: 'أدخل رقم الهاتف لإرسال رمز تحقق لمرة واحدة.',
    ...
    otpDescription: 'أدخل الرمز المكوّن من ستة أرقام المرسل إلى',
    ...
    codeSentBody: 'تحقق من رسائلك وأدخل الرمز للمتابعة.',
    loginSuccessTitle: 'تم تسجيل الدخول',
    loginSuccessBody: 'جارٍ نقلك إلى الصفحة المطلوبة.',
    verificationSuccessTitle: 'تم تأكيد رقم الهاتف',
    verificationSuccessBody: 'تم التحقق من الرقم ويمكنك متابعة التسجيل.',
    ...
    otpProviderTitle: 'خدمة الرسائل غير متاحة',
    ...
    registrationFormBody: 'أكمل بياناتك الأساسية بعد تأكيد رقم الهاتف.',
    ...
    invalidRegistrationTokenBody: 'ابدأ التحقق من رقم الهاتف مرة أخرى للمتابعة بأمان.',
    duplicateRegistrationTitle: 'الحساب موجود بالفعل',
    duplicateRegistrationBody: 'يوجد حساب مرتبط بهذا الرقم. ارجع إلى تسجيل الدخول للمتابعة.',
  ...
  en: {
    ...
    phoneLoginPrompt: 'Or continue with your phone number',
    phoneLoginAction: 'Verify phone number',
    phoneTitle: 'Verify your phone number',
    phoneDescription: 'Enter your phone number to receive a one-time verification code.',
    ...
    otpDescription: 'Enter the six-digit code sent to',
    ...
    codeSentBody: 'Check your messages and enter the code to continue.',
    loginSuccessTitle: 'You are logged in',
    loginSuccessBody: 'Taking you to the requested page.',
    verificationSuccessTitle: 'Phone number verified',
    verificationSuccessBody: 'Your number is verified and you can continue registration.',
    ...
    otpProviderTitle: 'Messaging service unavailable',
    ...
    registrationFormBody: 'Complete your basic details after verifying your phone number.',
    ...
    invalidRegistrationTokenBody: 'Start phone verification again to continue safely.',
    duplicateRegistrationTitle: 'Account already exists',
    duplicateRegistrationBody: 'An account is already linked to this phone number. Return to log in.',
  ...
  'zh-CN': {
    ...
    phoneLoginPrompt: '或使用手机号继续',
    phoneLoginAction: '验证手机号',
    phoneTitle: '验证手机号',
    phoneDescription: '请输入手机号以接收一次性验证码。',
    phoneLabel: '手机号',
    phonePlaceholder: '+20 100 000 0000',
    roleLabel: '账号类型',
    roleSeeker: '购房者',
    ...
    sendingCode: '正在发送验证码',
    otpTitle: '输入验证码',
    otpDescription: '请输入发送至以下号码的六位验证码：',
    codeLabel: '验证码',
    ...
    codeSentBody: '请查看短信并输入验证码继续。',
    loginSuccessTitle: '登录成功',
    loginSuccessBody: '正在前往请求的页面。',
    verificationSuccessTitle: '手机号已验证',
    verificationSuccessBody: '手机号验证成功，可以继续注册。',
    ...
    registrationFormBody: '验证手机号后，完成您的基本信息。',
    firstNameLabel: '名字',
    ...
    invalidRegistrationTokenBody: '请重新验证手机号后安全继续。',
    duplicateRegistrationTitle: '账号已存在',
    duplicateRegistrationBody: '此手机号已关联账号。返回登录页面继续。',
