...
function PropertyFilters({ locale, onApply, onClear }: { readonly locale: SupportedLocale; readonly onApply: (query: Partial<PropertyAdminListQuery>) => void; readonly onClear: () => void }) {
  const copy = getAdminPropertiesCopy(locale);
