...
function requestPropertyLabel(request: RequestData, locale: SupportedLocale): string {
  ...
  const payloadLabel = requestPayloadText(request, ['propertyName', 'propertyTitle', 'listingTitle']);
