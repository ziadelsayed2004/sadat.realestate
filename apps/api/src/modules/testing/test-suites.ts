export const TEST_SUITES = Object.freeze({
  unit: Object.freeze([
    ...
    'tests/admin/overview-repository.test.ts',
    ...
    'tests/provider/advertising-models.test.ts',
    ...
    'tests/requests/repository-search.test.ts',
    'tests/viewings/repository.test.ts',
    'tests/viewings/service.test.ts',
    'tests/articles/article-service.test.ts',
    'tests/articles/models.test.ts',
    ...
    'tests/settings/advertising-policy.test.ts',
    'tests/settings/privacy-security-policy.test.ts',
    ...
    'tests/public/bootstrap-sitemap.test.ts',
    ...
    'tests/database/production-launch.test.ts',
  ...
  integration: Object.freeze([
    ...
    'tests/docs/route-inventory.test.ts',
    'tests/fixtures/catalog.test.ts',
    'tests/database/artifacts.test.ts',
    'tests/database/health.test.ts',
    'tests/testing/journeys.test.ts',
    'tests/handoff/contract-freeze.test.ts',
  ...
  api: Object.freeze([
    ...
    'tests/provider/dashboard.test.ts',
    ...
    'tests/admin/overview-router.test.ts',
    'tests/admin/administrator-router.test.ts',
    'tests/commissions/account-router.test.ts',
    'tests/commissions/exception-router.test.ts',
    'tests/commissions/confirmation-router.test.ts',
    'tests/commissions/change-log-router.test.ts',
    'tests/reports/router.test.ts',
    'tests/articles/router.test.ts',
    'tests/cms/admin-content-router.test.ts',
    'tests/community/router.test.ts',
    ...
    'tests/security/upload-media-security.test.ts',
    'tests/security/public-projections.test.ts',
    'tests/payments/router.test.ts',
    'tests/security/request-projection.test.ts',
    'tests/security/assurance-report.test.ts',
    'tests/observability/observability.test.ts',
    'tests/observability/metrics.test.ts',
    'tests/observability/error-reporting.test.ts',
    'tests/observability/alerts.test.ts',
    'tests/observability/middleware-monitoring.test.ts'
  ])
});
