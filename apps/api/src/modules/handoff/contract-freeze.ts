...
export const SCREEN_OPERATION_MAP: Readonly<Record<string, readonly string[]>> = Object.freeze({
  ...
  'ADM-23': ['listAdminRequests'],
  'ADM-25': ['listAdminArticles', 'createAdminArticle', 'updateAdminArticle', 'transitionAdminArticle'],
  'ADM-26': ['listAdminArticleCategories', 'createAdminArticleCategory', 'updateAdminArticleCategory', 'deleteAdminArticleCategory'],
  'ADM-48': ['getAdminSettings', 'updateAdminSettings'], 'ADM-49': ['getAdminSettings', 'updateAdminSettings'],
