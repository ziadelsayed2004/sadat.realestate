...
<p>وفحص الصفحة الكاملة اجتاز أيضًا 72/72 حالة: HTTP 200، بلا خروج أفقي للـdocument أو صور مكسورة أو أخطاء متصفح. العناصر الداخلية المتحركة والجداول القابلة للسحب تظل محفوظة كتفاصيل تشخيصية.</p><p><a href="public-responsive-2026-09-06/results.json">نتائج الصفحات الكاملة</a> · <a href="public-footer-responsive-2026-09-06/results.json">نتائج الفوتر</a> · <a href="public-footer-responsive-2026-09-06/PUB-01-ar-desktop.png">لقطة ديسكتوب عربي</a> · <a href="public-footer-responsive-2026-09-06/PUB-01-ar-tablet.png">لقطة تابلت عربي</a> · <a href="public-footer-responsive-2026-09-06/PUB-01-ar-mobile.png">لقطة موبايل عربي</a></p><p class="warn">هذا يثبت سلامة التشغيل والريسبونسيف، لكنه لا يمنح ${publicRows.length} صفحة Public نسبة Figma كاملة قبل القياس البصري المنضبط.</p></section>
