...
const adminEvidence = `<section><h2>تحديث لوحة الإدارة وProduction — 7 سبتمبر 2026</h2>
<p class="ok"><strong>محليًا:</strong> 66/66 شاشة تشغيلية؛ 68/68 اختبارًا بصريًا للإدارة على Desktop بالعربية والإنجليزية؛ و440/440 حالة QA منفذة فعليًا بعد إعادة تشغيل حالة ADM-08 العابرة، مع 76 حالة skipped لأن بعض المواصفات معلنة Desktop-only.</p>
...
<p>تم جلب سياق Figma مباشرةً لـ ADM-01 (<code>6017:61879</code>) والـSidebar (<code>6017:62727</code>)، واستبدال أيقونات Unicode بأصول SVG محلية canonical. ما زالت المطابقة البصرية المباشرة الكاملة غير مقاسة: 22/131 Desktop و0/131 Responsive، لذلك لا يصح إعلان 100%.</p></section>`;
...
<p>7 سبتمبر 2026 · ${source.rows.length} شاشة/حالة. المرجع البصري المعتمد هو ملف Figma <code>Odl1Epn2u6lIEuIMmABT7o</code>، ودليل المستخدم مرجع للآلية مع اعتماد البريد الإلكتروني وOTP بدل التسجيل القديم بالهاتف.</p>
