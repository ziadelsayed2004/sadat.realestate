...
- Name: apps\web\tests\e2e\admin-sidebar-responsive.spec.ts >> Admin sidebar responsive shell >> keeps the admin logout action visible and functional
- Location: apps\web\tests\e2e\admin-sidebar-responsive.spec.ts:67:3
