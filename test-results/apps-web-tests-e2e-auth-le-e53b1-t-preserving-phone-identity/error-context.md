...
- Name: apps\web\tests\e2e\auth.spec.ts >> legacy phone verification alias redirects in the browser without preserving phone identity
- Location: apps\web\tests\e2e\auth.spec.ts:212:1
...
Call log:
  - navigating to "/auth/verify-phone?lang=ar&purpose=registration&roleType=seeker&phone=%2B201000000000", waiting until "load"
