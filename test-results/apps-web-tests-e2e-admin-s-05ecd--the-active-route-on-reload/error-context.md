...
- Name: apps\web\tests\e2e\admin-sidebar-responsive.spec.ts >> Admin sidebar responsive shell >> collapses each category independently and restores the active route on reload
- Location: apps\web\tests\e2e\admin-sidebar-responsive.spec.ts:89:3
