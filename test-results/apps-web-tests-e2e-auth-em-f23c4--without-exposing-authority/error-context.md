...
- Name: apps\web\tests\e2e\auth.spec.ts >> email verification sends, cools down, focuses digits, and verifies without exposing authority
- Location: apps\web\tests\e2e\auth.spec.ts:190:1
