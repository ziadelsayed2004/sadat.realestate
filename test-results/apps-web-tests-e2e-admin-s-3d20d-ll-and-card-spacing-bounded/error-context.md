...
- Name: apps\web\tests\e2e\admin-sidebar-responsive.spec.ts >> Admin sidebar responsive shell >> keeps navigation pinned during page scroll and card spacing bounded
- Location: apps\web\tests\e2e\admin-sidebar-responsive.spec.ts:116:3
