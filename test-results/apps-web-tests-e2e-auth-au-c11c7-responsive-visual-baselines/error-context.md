...
- Name: apps\web\tests\e2e\auth.spec.ts >> auth login and OTP approved states have responsive visual baselines
- Location: apps\web\tests\e2e\auth.spec.ts:242:1
...
Call log:
  - navigating to "/auth/login?lang=ar", waiting until "load"
